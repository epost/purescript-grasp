...
import Language.Grasp.AST (NodeF (..), Node, HyperEdge(..), HyperEdgeF(..), Label, Type, LabelAndType, GElem1(..), GElem1F(..))
...
gElem1 = GHyperEdge1 <$> try hyperEdge
     <|> GNode1      <$>     node
